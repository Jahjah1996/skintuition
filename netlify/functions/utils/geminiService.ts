    ...
    regimen: {
      ...
      properties: {
        morning: {
          ...
          description: "Morning routine steps",
          items: {
            type: SchemaType.OBJECT,
            properties: {
              step: {
        ...
        evening: {
          type: SchemaType.ARRAY,
          description: "Evening routine steps",
          items: {
            type: SchemaType.OBJECT,
            properties: {
              step: {
...
export async function analyzeSkinWithGemini(
  ...
  const prompt =
    ...
    "Additionally, based purely on the skin's visual appearance, generate a customized 3-step morning and evening skincare regimen in the regimen object. " +
